    ...
    public partial class RabaService : ServiceBase
    {
        ...
        private ArrayList GetSettingsFiles()
        {
            ...
            try
            {
                ...
                string szSettingExtension = string.Empty;
                if (this.mbLog)
                {
        ...
        private bool ProcessSettingsFile(string SettingsFile)
        {
            ...
            foreach (DataRow oRow in this.oDS.Tables[0].Rows)
            {
                ...
                this.ProcessTaskHandler(
                    ...
                    Convert.ToDateTime(oRow["ScanFileDateLessThan"]),
                    Convert.ToDateTime(oRow["ScanFileDateGreaterThan"]),
                    Convert.ToBoolean(oRow["ScanFileUseRelativeAgeYounger"]),
                    Convert.ToInt32(oRow["ScanFileAgeYounger"]),
                    Convert.ToBoolean(oRow["ScanFileUseRelativeAgeOlder"]),
                    Convert.ToInt32(oRow["ScanFileAgeOlder"]),
                    Convert.ToBoolean(oRow["OnlyCountWeekDays"]),
                    Convert.ToInt64(oRow["ScanFileSizeLessThan"]),
                    Convert.ToInt64(oRow["ScanFileSizeGreaterThan"]),
                    ...
                    Convert.ToBoolean(oRow["IncludeSubFolders"])
                );
            }
